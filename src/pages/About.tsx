    ...
    <div className="relative min-h-screen bg-background text-foreground font-sans flex flex-col overflow-hidden">
      ...
      <main className="relative z-10 pt-24 md:pt-32 px-4 flex flex-col items-center flex-1 pb-20 md:pb-28">
        ...
        <div className="w-full max-w-4xl space-y-6 text-white/80 text-xl md:text-2xl">
          <div className="bg-black/40 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10 animate-slide-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10 animate-slide-right">
