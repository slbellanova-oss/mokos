        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white/80 text-lg">
          ...
          <div className="bg-black/40 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10 animate-fade-rise-delay-2">
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              ...
              <a href="https://vk.ru/id1111264153" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-black/40 backdrop-blur-lg rounded-xl px-4 py-2 border border-white/10 text-white/80 hover:text-brand hover:border-brand/50 transition-all duration-300" aria-label="VK">
