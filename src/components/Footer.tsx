  ...
  return (
    <footer className="relative z-50 w-full bg-black/60 backdrop-blur-md py-4 px-4 md:px-8 mt-auto text-center md:text-left">
      ...
      <div className="flex justify-center gap-4 mt-4">
        <a href="https://max.ru/join/AkeAPHiS1P_quKiQSc1gaunkAKnwIz_yIeKmH5lvFRc" target="_blank" rel="noopener noreferrer" className="p-3 liquid-glass rounded-full hover:scale-[1.03] hover:bg-brand transition-all duration-300 cursor-pointer group" aria-label="Max">
        ...
        <a href="https://t.me/" target="_blank" rel="noopener noreferrer" className="p-3 liquid-glass rounded-full hover:scale-[1.03] hover:bg-brand transition-all duration-300 cursor-pointer group" aria-label="Telegram">
        ...
        <a href="https://vk.me/id1111264153" target="_blank" rel="noopener noreferrer" className="p-3 liquid-glass rounded-full hover:scale-[1.03] hover:bg-brand transition-all duration-300 cursor-pointer group" aria-label="VK">
